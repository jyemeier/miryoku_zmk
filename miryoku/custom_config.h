...
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             U_MT(LGUI, V),     &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
...
U_NP,              U_NP,              &kp LCTRL,         &kp SPACE,         &kp TAB,           &kp RET,           &kp SPACE,         &kp DEL,           U_NP,              U_NP
